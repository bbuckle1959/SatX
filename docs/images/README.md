# Screenshots for GitHub and docs

Add a PNG or JPG here for the repository landing page and social preview.
...
Repository **Settings → General → Social preview** accepts 1280×640. You can crop the same screenshot or export a wider banner.
